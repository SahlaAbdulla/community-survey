import { FiActivity, FiAirplay, FiAperture, FiBarChart2, FiBook, FiBookmark, FiBriefcase, FiCalendar, FiClipboard, FiCpu, FiFileText, FiFolderPlus, FiGift, FiGrid, FiHome, FiLayers, FiMail, FiMap, FiMessageSquare, FiPackage, FiPocket, FiRss, FiSettings, FiShare2, FiShoppingCart, FiUser, FiUsers } from "react-icons/fi";
const MENU_ITEMS = [{
  key: "navigation",
  label: "",
  isTitle: true
