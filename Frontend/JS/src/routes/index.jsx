...
// import MemberDetails from "../pages/apps/Member";
import MemberList from "../pages/apps/Member";
import UserList from "../pages/apps/FileManager";
import MemberDetails from "../pages/apps/Tasks/Form/MemberDetails";
...
// apps
const HouseList = React.lazy(() => import("../pages/apps/House"));
const AddHouseForm = React.lazy(() => import("../pages/apps/House/AddHouseForm"));
const AddHousePage = React.lazy(() =>
  import("../pages/apps/House/AddHousePage")
);
...
// - chat
const MemberDetailsApp= React.lazy(() => import("../pages/apps/Member"));
const AddEditMember = React.lazy(() =>
  import("../pages/apps/Member/AddEditMember")
);
...
const EducationDetail = React.lazy(() => import("../pages/apps/Email/EducationDetail"));
const EmailCompose = React.lazy(() => import("../pages/apps/Email/Compose"));
// - social
const VotersList = React.lazy(() => import("../pages/apps/SocialFeed/"));
// - companies
const Reports = React.lazy(() => import("../pages/apps/Companies/"));
// - tasks
const FamilyList = React.lazy(() => import("../pages/apps/Tasks/List"));
const WardDetails = React.lazy(() => import("../pages/apps/Tasks/Details"));
const ClusterIndex = React.lazy(() => import("../pages/apps/Tasks/Cluster"));
const VotersFormList = React.lazy(() => import("../pages/apps/Tasks/Form"));
...
// - house
const ViewHousePage = React.lazy(() =>
  import("../pages/apps/House/ViewHousePage")
);
...
// - file
const UserManagement = React.lazy(() => import("../pages/apps/FileManager"));
...
const oldHouseRedirect = {
  path: "/apps/house",
  element: <Navigate to="/houses" replace />,
  route: PrivateRoute
};
...
const chatAppRoutes = {
  ...
  roles: ["Admin"],
  icon: "message-square",
  element: <MemberDetailsApp />
};
const oldMemberRedirect = {
  path: "/apps/member",
...
const oldVoterRedirect = {
  path: "/apps/social-feed",
  element: <Navigate to="/VotersList" replace />,
  route: PrivateRoute
};
...
const taskAppRoutes = {
  ...
  {
    path: "/apps/tasks/cluster",
    name: "Task List",
    element: <ClusterIndex />,
    route: PrivateRoute
  },
  {
    path: "/apps/tasks/form",
    name: "Task List",
    element: <VotersFormList />,
    route: PrivateRoute
  },
  {
  path: "/members/add",
...
// const memberAliasRoute = {
//   path: "/members",
//   element: <Navigate to="/apps/member" replace />,
//   route: PrivateRoute
// };
...
const appRoutes = [calendarAppRoutes,oldHouseRedirect,oldVoterRedirect, chatAppRoutes,oldMemberRedirect, ecommerceAppRoutes, crmAppRoutes, emailAppRoutes, socialAppRoutes, companiesAppRoutes, projectAppRoutes, taskAppRoutes, contactsRoutes, ticketsRoutes, fileAppRoutes];
